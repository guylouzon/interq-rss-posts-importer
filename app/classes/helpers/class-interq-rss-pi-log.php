...
class InterQ_Rss_Pi_Log {
    ...
    public function init(): void {
        ...
        add_action('wp_ajax_interq_rss_pi_load_log', [$this, 'load_log']);
        add_action('wp_ajax_interq_rss_pi_clear_log', [$this, 'clear_log']);
    }
    ...
    public function load_log(): void {
        ...
        if (!file_exists(INTERQ_RSS_PI_LOG_PATH . 'log.txt')) {
            ...
            $log = file_get_contents(INTERQ_RSS_PI_LOG_PATH . 'log.txt');
        }

        // include the template to display it
        include(INTERQ_RSS_PI_PATH . 'app/templates/log.php');
        die();
    }
    ...
    public function clear_log(): void {
        ...
        <div id="message" class="updated">
            <p><strong><?php esc_html_e('Log has been cleared.', 'interq-rss-posts-importer'); ?></strong></p>
        </div>
        <?php
        die();
    }
     ...
     * 
     * @global object $interq_rss_post_importer Global object
