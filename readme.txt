...
= Core Features =
* **Automated Import:** Uses WordPress Cron to fetch feeds automatically.
* **Full Text Support:** Import entire article contents rather than just snippets.
* **Custom Assignment:** Set specific authors and categories per feed source.
* **SEO Optimized:** Options to append no-follow tags to outbound links and block search indexing for duplicate content protection.
* **Templating:** Simple system to format imported content, including backlinks and excerpts.
...
* Security: Hardened input sanitization on settings save.
* Maintenance: Updated internal libraries for better performance.
...
= 2.0.0 =
* Re-factored and rewritten core logic.
* Added support for keyword/regex filtering.